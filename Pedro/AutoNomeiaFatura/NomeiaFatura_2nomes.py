...
if len(pdf_files) == 1 and len(xml_files) == 1:
    ...
    destinatario = root.find('.//nfe:dest/nfe:xNome', ns).text.split()[:2]  # Nome do destinatário (duas primeiras palavras)
    ...
    new_name = f"{mes_ano}_NF_{destinatario}_{municipio}_{quantidade}MWh"
